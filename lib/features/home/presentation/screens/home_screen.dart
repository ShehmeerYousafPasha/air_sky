...
class _HomeScreenState extends ConsumerState<HomeScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () => ref.read(recentSearchesProvider.notifier).refresh(),
        child: ListView(
          ...
          children: <Widget>[
                ...
                return _DestinationCard(
                      ...
                      onTap: () {
                        ref
                            ...
                            .setToAirport(destination['code'] ?? 'DXB');
                        context.push(RoutePaths.search);
                      },
                    )
            ...
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  final Map<String, String> deal = _dealCards[index];
                  return _DealCard(
                    deal: deal,
                    onTap: () {
                      ref
                          .read(searchFormControllerProvider.notifier)
                          .setToAirport(deal['code'] ?? 'DXB');
                      context.push(RoutePaths.search);
                    },
                  );
                },
            ...
            Row(
              ...
              children: List<Widget>.generate(_dealCards.length, (int index) {
  ...
  static final List<Map<String, String>>
  _popularDestinations = <Map<String, String>>[
    <String, String>{
      'city': 'Dubai',
  ...
  static final List<Map<String, String>> _dealCards = <Map<String, String>>[
    <String, String>{
      'title': 'Weekend steal',
      'route': 'KHI -> DXB',
      'code': 'DXB',
